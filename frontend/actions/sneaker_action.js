...
export const fetchSneakers = (maxId) => dispatch => (
    SneakerUtil.fetchSneakers(maxId).then(sneakers => dispatch(receiveSneakers(sneakers)))
)

export const fetchSneaker = (sneakerId) => dispatch => (
    SneakerUtil.fetchSneaker(sneakerId).then(sneaker => dispatch(receiveSneaker(sneaker)))
)
