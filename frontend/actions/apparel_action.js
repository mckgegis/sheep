...
export const fetchApparels = maxId => dispatch =>
  ApparelUtil.fetchApparels(maxId).then(apparels =>
    dispatch(receiveApparels(apparels))
  );

export const fetchApparel = apparelId => dispatch =>
  ApparelUtil.fetchApparel(apparelId).then(apparel =>
    dispatch(receiveApparel(apparel))
  );
