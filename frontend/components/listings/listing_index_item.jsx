...
const ListingIndexItem = ({
  ...
  const button = currentUser ? (
    ...
    <Link to="/login">
      <button className="add-to-cart">Log In to Purchase</button>
    </Link>
  );
    ...
    <div className="listing-index-container">
      ...
      <div className="listing-index-details-container">
        <div className="listing-index-details">
          ...
          <div className="listing-index-detail-value">{product.name}</div>
        </div>
        <div className="listing-index-details">
          <div className="listing-index-detail-key">Size</div>
          <div className="listing-index-detail-value">{listing.size}M</div>
        </div>
        <div className="listing-index-details">
          <div className="listing-index-detail-key">Condition</div>
          <div className="listing-index-detail-value">New</div>
        </div>
        <div className="listing-index-details">
          <div className="listing-index-detail-key">Box Condition</div>
          <div className="listing-index-detail-value">Good Condition</div>
        </div>
      </div>
